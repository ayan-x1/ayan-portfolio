...
export default function ExpandableProjectCard({ projects, featured = false }: ExpandableProjectCardProps) {
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
        {projects.map((project, index) => (
          <motion.div
            ...
            className="group relative bg-white dark:bg-neutral-900 rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 cursor-pointer border border-neutral-200 dark:border-neutral-700 hover:border-primary/50"
            whileHover={{ y: -5 }}
          >
